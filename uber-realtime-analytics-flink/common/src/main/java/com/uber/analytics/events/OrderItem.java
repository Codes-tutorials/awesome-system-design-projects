...
public class OrderItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2192729138881979768L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderItem\",\"namespace\":\"com.uber.analytics.events\",\"fields\":[{\"name\":\"itemId\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"unitPrice\",\"type\":\"double\"},{\"name\":\"totalPrice\",\"type\":\"double\"}]}");
   ...
   */
  public OrderItem(java.lang.CharSequence itemId, java.lang.CharSequence name, java.lang.Integer quantity, java.lang.Double unitPrice, java.lang.Double totalPrice) {
    this.itemId = itemId;
    this.name = name;
   ...
   */
  public static com.uber.analytics.events.OrderItem.Builder newBuilder() {
    return new com.uber.analytics.events.OrderItem.Builder();
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.uber.analytics.events.OrderItem.Builder newBuilder(com.uber.analytics.events.OrderItem.Builder other) {
    if (other == null) {
      return new com.uber.analytics.events.OrderItem.Builder();
    } else {
      return new com.uber.analytics.events.OrderItem.Builder(other);
    }
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.uber.analytics.events.OrderItem.Builder newBuilder(com.uber.analytics.events.OrderItem other) {
    if (other == null) {
      return new com.uber.analytics.events.OrderItem.Builder();
    } else {
      return new com.uber.analytics.events.OrderItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.uber.analytics.events.OrderItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.uber.analytics.events.OrderItem other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.itemId)) {
        this.itemId = data().deepCopy(fields()[0].schema(), other.itemId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.OrderItem.Builder setItemId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.OrderItem.Builder clearItemId() {
      itemId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.OrderItem.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.OrderItem.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.OrderItem.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.OrderItem.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.OrderItem.Builder setUnitPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.OrderItem.Builder clearUnitPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.OrderItem.Builder setTotalPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.OrderItem.Builder clearTotalPrice() {
