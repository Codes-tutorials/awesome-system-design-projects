...
public class Location extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5665928686996316287L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Location\",\"namespace\":\"com.uber.analytics.events\",\"fields\":[{\"name\":\"latitude\",\"type\":\"double\"},{\"name\":\"longitude\",\"type\":\"double\"},{\"name\":\"address\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public Location(java.lang.Double latitude, java.lang.Double longitude, java.lang.CharSequence address) {
   ...
   */
  public static com.uber.analytics.events.Location.Builder newBuilder() {
    return new com.uber.analytics.events.Location.Builder();
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static com.uber.analytics.events.Location.Builder newBuilder(com.uber.analytics.events.Location.Builder other) {
    if (other == null) {
      return new com.uber.analytics.events.Location.Builder();
    } else {
      return new com.uber.analytics.events.Location.Builder(other);
    }
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static com.uber.analytics.events.Location.Builder newBuilder(com.uber.analytics.events.Location other) {
    if (other == null) {
      return new com.uber.analytics.events.Location.Builder();
    } else {
      return new com.uber.analytics.events.Location.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Location>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.uber.analytics.events.Location.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.uber.analytics.events.Location other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.latitude)) {
        this.latitude = data().deepCopy(fields()[0].schema(), other.latitude);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.Location.Builder setLatitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.Location.Builder clearLatitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.Location.Builder setLongitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.Location.Builder clearLongitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.Location.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uber.analytics.events.Location.Builder clearAddress() {
      address = null;
